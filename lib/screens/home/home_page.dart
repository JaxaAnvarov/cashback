                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  ...
                                  blurRadius: getProportionateScreenWidth(3.0),
                              ...
                              children: [
                                Container(
                                  margin: EdgeInsets.only(
                                    ...
                                    right: getProportionateScreenWidth(115.0),
                                  ),
                                  width: getProportionateScreenWidth(225.0),
                                  child: MyTextWidget(
                                      color: AppColors().kPrimaryText1Colors,
                                ...
                                Container(
                                  margin: EdgeInsets.only(
                                    ...
                                    left: getProportionateScreenWidth(303.0),
                                  ),
                                  child: SvgPicture.asset(AppIcons().qwifi),
                                ),
                                Container(
                                  margin: EdgeInsets.only(
                                    left: getProportionateScreenWidth(24.0),
                                    right: getProportionateScreenWidth(55.0),
                                  ),
